    ...
    <div class="relative max-w-md w-full mx-auto">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden border border-white/30">
            ...
            <div class="p-8">
                ...
                <button class="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-xl bg-white text-gray-700 font-medium hover:bg-gray-50 transition-all shadow-sm hover:shadow-md mb-6">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center">
                        <span class="px-3 text-gray-500 text-xs font-medium uppercase tracking-wider">
                ...
                <form id="registrationForm" class="space-y-5">
                    ...
                    <div class="space-y-1">
                        ...
                        <p id="nameError" class="hidden text-sm text-red-600 mt-1"></p>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <p id="confirmPasswordError" class="hidden text-sm text-red-600 mt-1"></p>
                    </div>
                    ...
                    <p id="termsError" class="hidden text-sm text-red-600 mt-1">You must agree to the terms and conditions</p>
